...
<body>
        ...
        <div class="container-fluid w-auto">
            <div class="row h-27">
                ...
                <div class="col col-lg-7 col-sm-6 bg-dark">
                    <h2 class="my-header-title text-white">Credisy Online Banking</h2>
                ...
                <nav class="navbar navbar-expand-sm navbar-dark navbar-custom">
                    ...
                    <div class="collapse navbar-collapse" id="navbarMenu">
                        <ul class="navbar-nav mx-right">
                            ...
                            <li class="nav-item">
                                <a href="customerlogin.jsp" class="nav-link">Login</a>
                            </li>
                        </ul>
                    </div>
                </nav>
	...
	<img src="image/home.png" class="img-fluid h-100" style="max-width: 100%; height:auto;" alt="responsive image">
